<template>
  <div class="relative mx-2" v-click-outside="close">
    <div @click="currentActive = !currentActive" class="font-light cursor-pointer border border-select text-select lg:text-base text-sm w-full p-3 flex items-center justify-between ">
